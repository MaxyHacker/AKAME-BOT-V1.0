...
module.exports = akame = async (akame, m, chatUpdate, store) => {
    try {
        ...
        //buttons Tambahan
        const ntiktok = ('©Andymrlit\nIG/INSTAGRAM:\nhttps://instagram.com/andy_mr_lit')  //ubah di config biar ngk emror
